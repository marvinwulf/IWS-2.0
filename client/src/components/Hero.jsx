...
const Hero = () => {
  ...
  return (
    <Section crosses crossesOffset="lg:translate-y-[5rem]" customPaddings id="hero">
      ...
      <div className="absolute top-0 left-0 w-screen h-svh flex justify-center">
        ...
        <div className="w-screen max-w-[1920px] h-svh max-h-[1080px] z-0">
          <iframe type="text/html" src="/my.spline.design.htm" alt="background" width="100%" height="100%"></iframe>
          {/* <iframe
      ...
      <div className="container">
        <div className="h-svh flex items-center justify-center text-center max-h-[1080px] min-h-[600px]">
          <div className="relative mx-12 z-10">
            <h1
              className={`h1 mb-5 transition-all ease-out duration-1000 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
            >
              Pflanzenhaltung. Überall.
            </h1>
            <h1
              className={`h2 relative -top-5 mb-6 font-semibold transition-all ease-out duration-1000 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
            >
              Streamlined durch{" "}
              <span className="inline-block text-transparent gradient-text animate-gradient ">MS Solutions.</span>
            </h1>

            <p
              className={`body-1 max-w-3xl mx-auto mb-2 text-n-2 lg:mb-4 transition-all ease-out delay-150 duration-1000 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
            >
              Diskrete und im Topf vollständig integrierte autonome Pflanzenbewässerungssysteme, ausgelegt für das
              optimale Decken der Bedürfnisse von sehr vielen Pflanzen über eine verteilte Fläche.
            </p>

            <p
              className={`body-1 max-w-3xl mx-auto text-n-2 transition-all delay-300  ease-out duration-1000 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
            >
            ...
            <p
              className={`body-1 max-w-3xl mx-auto text-color-1 transition-all delay-300  ease-out duration-1000 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
            >
              Völlig lokal.
