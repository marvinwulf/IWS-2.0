...
import monologo from "../assets/mslogomonolight.svg";
...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="hidden relative z-50 top-svh left-0 right-10 h-0.25 bg-n-6 pointer-events-none xl:block">
        <PlusSvg className="hidden absolute -top-[0.3rem] left-[2.1875rem] z-50 pointer-events-none xl:block" />
        <PlusSvg className="hidden absolute -top-[0.3rem] right-[2.1875rem] z-50 pointer-events-none xl:block" />
      </div>
    </Section>
  );
};
